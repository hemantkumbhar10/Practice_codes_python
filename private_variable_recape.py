...
#output says the private variables cannot be accessed outof that class even in another class
#we need to make get-set method to get those private variables so we can access them outside of tht class